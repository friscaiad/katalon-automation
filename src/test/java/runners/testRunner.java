package app.katalon.runners;

import app.katalon.browserFactory;
import app.katalon.driverManager;
...
@CucumberOptions(features = "src/test/java/app/katalon/features",
        glue = "app.katalon.steps",
        tags = "",
        plugin = {
                "pretty",
